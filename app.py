...
# Filtro com base nas seleções feitas na barra lateral.
df_filtrado = df[
...
# Conteúdo
st.title("📊 Dashboard - Análise de Salários na Área de Dados")
st.markdown(
    "Explore os dados salariais na área de dados nos últimos anos. Utilize os filtros da barra lateral para fazer sua análise."
)
...
# Tabela com titulo das colunas renomados
if not df_filtrado.empty:
    st.dataframe(
        ...
        .rename(
            columns={
                ...
                "contrato": "Tipo de Emprego",
                "cargo": "Cargo",
                "moeda": "Moeda",
                "usd": "Salário (USD)",
                "remoto": "Modaliade de Trabalho",
                "empresa": "País da Empresa",
                "tamanho_empresa": "Porte da Empresa",
                "residencia_iso3": "Local da Empresa",
            }
        )
        .drop(columns=["salario"], errors="ignore")
        .drop(columns=["residencia"], errors="ignore")
        .drop(columns=["País da Empresa"], errors="ignore"),
